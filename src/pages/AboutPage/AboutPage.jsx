  ...
  return (
    <section className="about">
      <div className="about__container about__container--image">
        <h2 className="about__title">Hello <strong>!</strong></h2>
      </div>
      ...
      <div className="about__container about__container--bio">
        <p className="about__subtitle">
          ...
          <p className="about__subtitle--1">Through a 12-week coding bootcamp, I gained expertise in
          ...
          <p className="about__subtitle--1">I participated in three Hackathons, including one with <strong>META</strong>. There, I led a team to develop
          ...
          My goal is to build innovative solutions, foster collaboration, be an
          adaptable leader, and drive impactful results for your team.</p>
        </p>

        <p className="about__subtitle--1">
        Additionally, everything I create incorporates an audio experience to calm your mind and improve the overall user experience.
        </p>
      </div>

      <div className="about__container about__container--list">
        <h2 className="about__title">SKILLS + <strong>TOOLS</strong></h2>
      </div>
